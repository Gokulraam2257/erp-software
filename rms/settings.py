...
ALLOWED_HOSTS = ['erp-software.herokuapp.com','localhost']
...
EMAIL_HOST_USER = 'gokulraam.2257@gmail.com'
# EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD')#this is the jjpassword that i use in gmail 
EMAIL_HOST_PASSWORD = 'gokul2257'#I USE app password from gmail  BECAUSE OF ERROR DURING FORGET PASSWORD and it is more secure
